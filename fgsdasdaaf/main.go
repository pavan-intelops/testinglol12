...
import (
	...
	restcontrollers "github.com/pavan-intelops/testinglol12/fgsdasdaaf/pkg/rest/server/controllers"
...
func main() {
	...
	soemthingController, err := restcontrollers.NewSoemthingController()
	if err != nil {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.PUT("/soemthings/:id", soemthingController.UpdateSoemthing)

		v1.DELETE("/soemthings/:id", soemthingController.DeleteSoemthing)
